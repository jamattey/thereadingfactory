    ...
    <Wrapper>
      ...
      <Activities>
        {activityList.map((activity, index) => (
          <Activity key={index}>
            <FontAwesomeIcon icon={activity.icon} className="text-4xl" />
            {activity.activity}
...
const Activities = tw.ul`w-full grid md:grid-cols-2  `;
const Activity = tw.li`w-1/2 mb-5 flex text-yellow-dark flex-col items-center text-xl`;
const Details = tw.details`flex flex-col items-center`;
